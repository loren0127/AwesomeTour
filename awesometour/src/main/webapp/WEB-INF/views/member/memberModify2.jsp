				...
				<form:errors element="div" cssClass="error-color" />
	                ...
	                <div class="row imageGallery1" id="gallery" align="center">
	                    <div class="col-md-4 gallery_item">
	                        <div class="gallery_img" style="align:center;">
	                            <img src="${pageContext.request.contextPath}/resources/img/1.png" alt=""><br><br>
	                            <input type="checkbox" name="ch" value="야외활등">야외활동<br><br>
	                        </div>
	                    </div>
	                    <div class="col-md-4 gallery_item">
	                        <div class="gallery_img" style="align:center;">
	                            <img src="${pageContext.request.contextPath}/resources/img/2.PNG" alt=""><br><br>
	                            <input type="checkbox" name="ch" value="기술">기술<br><br>
	                        </div>
	                    </div>
						<div class="col-md-4 gallery_item">
	                        <div class="gallery_img" style="align:center;">
	                            <img src="${pageContext.request.contextPath}/resources/img/3.PNG" alt=""><br><br>
	                    ...
	                    <Br>
	                   	 <div class="col-md-4 gallery_item">
	                        <div class="gallery_img" style="align:center;">
	                            <img src="${pageContext.request.contextPath}/resources/img/4.PNG" alt=""><br><br>
	                            <input type="checkbox" name="ch" value="건강과 웰빙">건강과 웰빙<br><br>
	                        </div>
	                    </div>
	                    <div class="col-md-4 gallery_item">
	                        <div class="gallery_img" style="align:center;">
	                            <img src="${pageContext.request.contextPath}/resources/img/5.PNG" alt=""><br><br>
	                            <input type="checkbox" name="ch" value="스포츠">스포츠<br><br>
	                        </div>
	                    </div>
						<div class="col-md-4 gallery_item">
	                        <div class="gallery_img" style="align:center;">
	                            <img src="${pageContext.request.contextPath}/resources/img/6.PNG" alt=""><br><br>
	                    ...
	                    <br>
	                     <div class="col-md-4 gallery_item">
	                        <div class="gallery_img" style="align:center;">
	                            <img src="${pageContext.request.contextPath}/resources/img/7.PNG" alt=""><br>
	                            <input type="checkbox" name="ch" value="사진촬영">사진촬영
	                        </div>
	                    </div>
	                    <div class="col-md-4 gallery_item">
	                        <div class="gallery_img" style="align:center;">
	                            <img src="${pageContext.request.contextPath}/resources/img/8.PNG" alt=""><br>
	                            <input type="checkbox" name="ch" value="음식">음식
	                        </div>
	                    </div>
						<div class="col-md-4 gallery_item">
	                        <div class="gallery_img" style="align:center;">
	                            <img src="${pageContext.request.contextPath}/resources/img/9.PNG" alt=""><br>
					...
					<div class="row imageGallery1" id="gallery" align="center">
	                    <div class="col-md-6 gallery_item">
	                        <div class="gallery_img" style="align:center;">
	                            <img src="${pageContext.request.contextPath}/resources/img/1.png" alt=""><br>
