...
public class PagingUtilCircle {
	 ...
	 * */
	public PagingUtilCircle(int currentPage, int totalCount, int rowCount,
	...
	public PagingUtilCircle(String keyfield, String keyword, int currentPage, int totalCount, int rowCount,
			int pageCount,String pageUrl) {
	...
	public PagingUtilCircle(String keyfield, String keyword, int currentPage, int totalCount, int rowCount,
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				...
				pagingHtml.append("<span style='color:gray'>●</span>");
				pagingHtml.append("</a>");
			}
			pagingHtml.append("&nbsp;");
		}
