...
public class ReservationCommand {
	...
	public void setRv_reauest(String rv_request) {
	...
	public String toString() {
		return "ReservationCommand [rv_num=" + rv_num + ", rv_money=" + rv_money + ", rv_people=" + rv_people
				...
				+ ", rv_reg_date=" + rv_reg_date + ", rv_status=" + rv_status + ", rv_message=" + rv_message
				+ ", rv_reauest=" + rv_request + ", acc_name=" + acc_name + ", ag_grade=" + ag_grade 
				+ ", im_cover_name=" + im_cover_name + ", acc_money=" + acc_money
				+ ", acc_address1=" + acc_address1 + ", acc_address2=" + acc_address2 + ", acc_in=" + acc_in
				+ ", acc_out=" + acc_out + ", se_name=" + se_name + "]";
	}
